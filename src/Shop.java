/*
Write a java program using Swing to validate user login information using dialog boxes.
a. Once validated, allow the user to enter the customer id, if the person is a new customer, else check whether the customer exists in a collection and obtain
    the customer id.
...
d. Using option dialog box, indicate the types of discount available for the customer. On clicking on the print button, print the details in information
    dialog box.
*/
...
public class Shop implements ActionListener{
    ...
    String user="Amy", pass="1234", un="", pw;
    int id;
